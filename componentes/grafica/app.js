/* ============================================================
   APP.JS - COMPONENTE TARJETA GRÁFICA / GPU
   Feria FP Bajo Aragón - Hardware RA

   - Preguntas exclusivas de tarjeta gráfica / GPU.
   - Admin: feriadelafp.
...
const COMPONENTE_ID = CONFIG_LOCAL.componenteId || 'gpu';
...
const NOMBRE_COMPONENTE = 'Tarjeta gráfica / GPU';

const MENSAJE_MARCADOR_DETECTADO = '✅ Marcador detectado. Explora la tarjeta gráfica.';
const MENSAJE_MARCADOR_PERDIDO = 'Enfoca de nuevo el marcador de la tarjeta gráfica.';
const MENSAJE_FINAL = 'Has terminado las preguntas de tarjeta gráfica / GPU.';
const SIGUIENTE_COMPONENTE = 'Ahora puedes continuar con cables y conexiones internas.';

const PREGUNTAS = [
    {
        texto: '¿Cuál es la función principal de una tarjeta gráfica dedicada?',
        opciones: [
            {
                texto: 'Procesar gráficos, vídeo e imágenes y enviar señal al monitor',
                correcta: true,
                feedbackCorrecto: 'Correcto. La GPU se encarga de procesar información gráfica y generar la imagen que se muestra en pantalla.'
            },
            {
            ...
            {
                texto: 'Convertir corriente alterna en continua',
                correcta: false,
    ...
    },
    {
        ...
        opciones: [
            {
                texto: 'En una ranura PCI Express x16',
                correcta: true,
                feedbackCorrecto: 'Muy bien. Las tarjetas gráficas dedicadas suelen instalarse en la ranura PCI Express x16 de la placa base.'
            },
            {
            ...
            {
                texto: 'En el conector CPU_FAN',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. CPU_FAN se usa para conectar el ventilador del procesador.'
            }
        ]
    },
    {
        texto: '¿Qué conexiones se utilizan habitualmente para conectar un monitor moderno a una tarjeta gráfica?',
        opciones: [
            {
                texto: 'HDMI o DisplayPort',
                correcta: true,
                feedbackCorrecto: 'Correcto. HDMI y DisplayPort son conexiones habituales para transmitir vídeo y audio a monitores actuales.'
            },
            {
                texto: 'SATA de datos',
                correcta: false,
            ...
            },
            {
                texto: 'Power SW',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Power SW es el conector del botón de encendido de la carcasa.'
            }
        ]
    },
    {
        texto: '¿Qué debe comprobarse antes de instalar una tarjeta gráfica potente?',
        opciones: [
            {
                texto: 'Que la fuente tenga potencia suficiente y conectores PCIe adecuados',
                correcta: true,
                feedbackCorrecto: 'Muy bien. Algunas tarjetas gráficas necesitan alimentación adicional mediante conectores PCIe de 6, 8, 12 o más pines.'
            },
            {
                texto: 'Que la RAM esté pegada con pasta térmica',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La RAM no se instala con pasta térmica.'
            },
            {
                texto: 'Que el disco duro sea del mismo color que la GPU',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. El color no determina la compatibilidad entre componentes.'
            }
        ]
    },
    {
        texto: '¿Qué es la VRAM de una tarjeta gráfica?',
        opciones: [
            {
                texto: 'Memoria propia de la GPU para trabajar con datos gráficos',
                correcta: true,
                feedbackCorrecto: 'Correcto. La VRAM almacena texturas, imágenes, búferes y otros datos gráficos que necesita la tarjeta gráfica.'
            },
            {
                texto: 'Una copia de seguridad automática del sistema operativo',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Las copias de seguridad se guardan en unidades de almacenamiento o servicios externos.'
            },
            {
                texto: 'El cable principal de alimentación de la placa base',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La VRAM es memoria de vídeo, no un cable.'
            }
        ]
    }
];
