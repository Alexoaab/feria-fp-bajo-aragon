/* ============================================================
   ...
   - Preguntas exclusivas de la fuente de alimentación.
   - Admin: feriadelafp.
...
const COMPONENTE_ID = CONFIG_LOCAL.componenteId || 'fuente';
...
/* ============================================================
   PREGUNTAS EXCLUSIVAS DE FUENTE DE ALIMENTACIÓN
   ============================================================ */

const NOMBRE_COMPONENTE = 'Fuente de alimentación';

const MENSAJE_MARCADOR_DETECTADO = '✅ Marcador detectado. Explora la fuente de alimentación.';
const MENSAJE_MARCADOR_PERDIDO = 'Enfoca de nuevo el marcador de la fuente de alimentación.';
const MENSAJE_FINAL = 'Has terminado las preguntas de la fuente de alimentación.';
const SIGUIENTE_COMPONENTE = 'Ahora puedes continuar con la placa base.';

const PREGUNTAS = [
    {
        texto: '¿Cuál es la función principal de la fuente de alimentación?',
        opciones: [
            {
                texto: 'Convertir y distribuir energía eléctrica a los componentes internos',
                correcta: true,
                feedbackCorrecto: 'Correcto. La fuente transforma la corriente de entrada y proporciona diferentes tensiones a la placa base, CPU, discos, ventiladores y tarjetas.'
            },
            {
                texto: 'Procesar gráficos 3D y vídeo',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Esa función corresponde a la tarjeta gráfica o GPU.'
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                texto: 'Conector ATX de 24 pines',
                correcta: true,
            ...
            },
            {
                texto: 'Conector HDMI',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. HDMI transmite vídeo y audio, no alimentación eléctrica para la placa base.'
            },
            {
                texto: 'Conector SATA de datos',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. SATA de datos sirve para comunicar una unidad de almacenamiento con la placa base.'
            }
        ]
    },
    {
        texto: '¿Qué conector suele alimentar directamente la CPU?',
        opciones: [
            {
                texto: 'Conector EPS CPU de 4 u 8 pines',
                correcta: true,
                feedbackCorrecto: 'Correcto. El conector EPS CPU proporciona alimentación específica al procesador.'
            },
            {
                texto: 'Conector USB frontal',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. USB frontal conecta los puertos USB de la carcasa con la placa base.'
            },
            {
                texto: 'Conector de audio frontal',
                correcta: false,
    ...
    {
        texto: '¿Qué hay que comprobar antes de instalar una tarjeta gráfica potente?',
        opciones: [
            {
                texto: 'Que la fuente tenga potencia suficiente y conectores PCIe adecuados',
                correcta: true,
                feedbackCorrecto: 'Muy bien. Muchas tarjetas gráficas necesitan alimentación adicional mediante conectores PCIe de 6, 8 o más pines.'
            },
            {
                texto: 'Que la fuente tenga ranuras DIMM',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Las ranuras DIMM están en la placa base y sirven para instalar memoria RAM.'
            },
            {
                texto: 'Que la fuente tenga salida HDMI',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La fuente no genera señal de vídeo; eso lo hace la GPU o la salida gráfica de la placa.'
            }
        ]
    },
    {
        texto: '¿Qué ventaja tiene una fuente modular?',
        opciones: [
            {
                texto: 'Permite conectar solo los cables necesarios',
                correcta: true,
                feedbackCorrecto: 'Correcto. Una fuente modular ayuda a reducir cables sobrantes, mejora el orden interno y puede favorecer el flujo de aire.'
            },
            {
                texto: 'No necesita cable de corriente',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Toda fuente necesita recibir corriente eléctrica.'
            },
            {
                texto: 'Sustituye a la placa base',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La fuente alimenta el equipo, pero no sustituye a la placa base.'
            }
        ]
    }
];
