...
const PREGUNTAS = [
    {
        ...
        opciones: [
            {
                texto: 'Transformar y distribuir energía eléctrica a los componentes del ordenador',
                correcta: true,
                feedbackCorrecto: 'Correcto. La fuente convierte la energía de la red y alimenta los componentes internos.'
            },
            {
            ...
            {
                texto: 'Procesar instrucciones del sistema operativo',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Esa función corresponde principalmente a la CPU.'
            }
        ]
    },
    {
        ...
        opciones: [
            {
                ...
                correcta: true,
                feedbackCorrecto: 'Muy bien. El conector ATX de 24 pines proporciona alimentación principal a la placa base.'
            },
            {
                texto: 'Conector HDMI',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. HDMI se usa para transmitir vídeo y audio.'
            },
            {
                texto: 'Conector RJ45',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. RJ45 se usa normalmente para red Ethernet.'
            }
        ]
    },
    {
        texto: '¿Qué conector suele alimentar el procesador?',
        opciones: [
            {
            ...
            },
            {
                ...
                correcta: false,
                feedbackIncorrecto: 'No es correcto. SATA de datos comunica discos con la placa base.'
            },
            {
                texto: 'Conector VGA',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. VGA es una conexión de vídeo.'
            }
        ]
    },
    {
        ...
        opciones: [
            {
                texto: 'Porque puede mantener carga eléctrica peligrosa incluso desconectada',
                correcta: true,
                feedbackCorrecto: 'Muy bien. Las fuentes pueden contener condensadores cargados y deben manipularse con mucha precaución.'
            },
            {
                texto: 'Porque dentro está la memoria RAM',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La RAM se instala en la placa base, no dentro de la fuente.'
            },
            {
                texto: 'Porque se borran automáticamente los archivos del disco',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Abrir la fuente no borra archivos, pero sí puede ser peligroso.'
            }
        ]
    },
    {
        texto: '¿Qué hay que comprobar al elegir una fuente para un equipo con tarjeta gráfica dedicada?',
        opciones: [
            {
                texto: 'Que tenga potencia suficiente y conectores PCIe adecuados',
                correcta: true,
                feedbackCorrecto: 'Correcto. Las tarjetas gráficas potentes pueden necesitar conectores PCIe y una fuente con potencia suficiente.'
            },
            {
                texto: 'Que tenga una pantalla integrada',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Las fuentes de alimentación no incluyen pantalla.'
            },
            {
                texto: 'Que sustituya a la placa base',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La fuente alimenta la placa base, pero no la sustituye.'
            }
        ]
    }
];
