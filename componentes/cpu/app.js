/* ============================================================
   APP.JS - COMPONENTE CPU / PROCESADOR
   Feria FP Bajo Aragón - Hardware RA

   - Preguntas exclusivas de la CPU.
   - Admin: feriadelafp.
...
const COMPONENTE_ID = CONFIG_LOCAL.componenteId || 'cpu';
...
/* ============================================================
   PREGUNTAS EXCLUSIVAS DE CPU / PROCESADOR
   ============================================================ */

const NOMBRE_COMPONENTE = 'CPU / Procesador';

const MENSAJE_MARCADOR_DETECTADO = '✅ Marcador detectado. Explora la CPU o procesador.';
const MENSAJE_MARCADOR_PERDIDO = 'Enfoca de nuevo el marcador de la CPU.';
const MENSAJE_FINAL = 'Has terminado las preguntas de la CPU.';
const SIGUIENTE_COMPONENTE = 'Ahora puedes continuar con la refrigeración.';

const PREGUNTAS = [
    {
        texto: '¿Cuál es la función principal de la CPU en un ordenador?',
        opciones: [
            {
                texto: 'Ejecutar instrucciones y procesar datos',
                correcta: true,
                feedbackCorrecto: 'Correcto. La CPU interpreta y ejecuta instrucciones del sistema operativo y de los programas.'
            },
            {
                texto: 'Guardar archivos de forma permanente',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Los archivos se guardan en unidades de almacenamiento, como HDD o SSD.'
            },
            {
                texto: 'Transformar la corriente eléctrica de entrada',
                correcta: false,
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                texto: 'En una ranura DIMM',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. Las ranuras DIMM se utilizan para instalar memoria RAM.'
            },
            {
                texto: 'En un conector SATA de datos',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. SATA de datos se utiliza para comunicar unidades de almacenamiento con la placa base.'
            }
        ]
    },
    {
        texto: '¿Para qué sirve la pasta térmica en el montaje de una CPU?',
        opciones: [
            {
                texto: 'Para mejorar la transferencia de calor entre la CPU y el disipador',
                correcta: true,
                feedbackCorrecto: 'Correcto. La pasta térmica rellena pequeñas imperfecciones y ayuda a transferir mejor el calor al disipador.'
            },
            {
                texto: 'Para pegar la CPU permanentemente a la placa base',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La CPU no se pega a la placa base; se coloca en el socket y se fija con su mecanismo de sujeción.'
            },
            {
                texto: 'Para aumentar la capacidad de la memoria RAM',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La pasta térmica no afecta a la capacidad de memoria.'
            }
        ]
    },
    {
        texto: '¿Qué puede ocurrir si la CPU no se refrigera correctamente?',
        opciones: [
            {
                texto: 'Puede reducir su rendimiento, bloquearse o apagar el equipo por seguridad',
                correcta: true,
                feedbackCorrecto: 'Muy bien. Una temperatura excesiva puede provocar bajada de rendimiento, reinicios, bloqueos o apagados de protección.'
            },
            {
                texto: 'Aumenta automáticamente el número de núcleos',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. El número de núcleos es una característica física del procesador.'
            },
            {
                texto: 'Convierte el SSD en memoria RAM',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. SSD y RAM son componentes diferentes con funciones distintas.'
            }
        ]
    },
    {
        texto: '¿Qué hay que comprobar antes de comprar una CPU para un equipo?',
        opciones: [
            {
                texto: 'Que sea compatible con el socket y chipset de la placa base',
                correcta: true,
                feedbackCorrecto: 'Correcto. Antes de elegir una CPU hay que comprobar la compatibilidad con la placa base y, si es necesario, la versión de BIOS.'
            },
            {
                texto: 'Que tenga el mismo color que la carcasa',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. El color no determina la compatibilidad ni el funcionamiento de la CPU.'
            },
            {
                texto: 'Que se conecte directamente al monitor por HDMI',
                correcta: false,
                feedbackIncorrecto: 'No es correcto. La CPU se instala en la placa base; la salida de vídeo depende de la placa, de la GPU o de gráficos integrados.'
            }
        ]
    }
];
